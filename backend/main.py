...
def generate_flights(origin: str, dest: str, date_str: str, travel_class: str = "Economy", return_date: Optional[str] = None) -> Dict[str, Any]:
    # Use route, date and class to seed the random generator for consistency
    ...
    ota_templates = [
        {"name": "EaseMyTrip", "badge": "Zero Convenience Fee", "cf_range": (0, 0), "promo_range": (150, 300), "url": "https://www.easemytrip.com"},
        {"name": "Yatra", "badge": "Bank Offers", "cf_range": (350, 450), "promo_range": (300, 500), "url": "https://www.yatra.com"},
        {"name": "MakeMyTrip", "badge": "Popular & Reliable", "cf_range": (350, 400), "promo_range": (200, 350), "url": "https://www.makemytrip.com"},
        {"name": "Cleartrip", "badge": "Fast Booking", "cf_range": (300, 400), "promo_range": (150, 250), "url": "https://www.cleartrip.com"},
        {"name": "Goibibo", "badge": "GoCash Cashback", "cf_range": (350, 420), "promo_range": (250, 300), "url": "https://www.goibibo.com"},
        {"name": "Ixigo", "badge": "Low Cancellation Fee", "cf_range": (250, 320), "promo_range": (150, 250), "url": "https://www.ixigo.com"}
    ]
